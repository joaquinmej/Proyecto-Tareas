...
<head>
  ...
  <title>Crear Subtarea | !Tus Tareas</title>
...
<div class="subtask-container ">
  <div class="subtask-header">
    ...
    <p class="text-muted">Añade una subtarea a la tarea principal</p>
  </div>
  ...
  <?php echo form_open('creartarea/guardarsub'); ?>
    ...
    <div class="mb-3">
      ...
      <select name="prioridad" id="selectPrioridad" class="form-select">
        <option value="0" class="priority-none">Sin prioridad</option>
        <option value="1" class="priority-low">Baja</option>
        <option value="2" class="priority-medium">Media</option>
        <option value="3" class="priority-high">Alta</option>
      </select>
    </div>
