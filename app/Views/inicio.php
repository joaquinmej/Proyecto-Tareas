...
<head>
  ...
  border-radius: 50%;
    ...
    .recordatorio-message {
      background-color:rgb(252, 216, 117);
      color:rgb(139, 96, 45);
      padding: 0.75rem;
      border-radius: 5px;
      margin-bottom: 1rem;
          ...
          <div class="row g-0">
            ...
            <div class="col-sm-9 col-7 position-relative">
              <div class="card-body py-2">
                ...
                <?php if(isset($tarea['fecha_recordatorio']) && $tarea['estado'] != 2){
                if($tarea['fecha_vencimiento'] > $fecha && $tarea['fecha_recordatorio'] <= $fecha ){?>
              
               <div class="recordatorio-message">
      <i class="bi bi-exclamation-triangle-fill me-2"></i>
      ¡La tarea esta por vencer!
    </div>
                 <?php }
                 }if($tarea['fecha_vencimiento'] <= $fecha && $tarea['estado'] != 2){
...
<?php foreach($colaborar as $colabo){
  if($colabo['prioridad'] == 0){
          $prioridad = "baja";
          $badgeClass = "bg-success";
        } else if($colabo['prioridad'] == 1){
          $prioridad = "media";
          $badgeClass = "bg-warning text-dark";
        } else {
           $prioridad = "alta";
...
<div class="card w-100 mb-3 shadow-sm task-card" data-priority="<?php echo $prioridad; ?>">
          <div class="row g-0">
            <!-- Barra de color lateral -->
            <div class="col-sm-1 col-2" style="background-color: <?php echo $colabo['color']; ?>;">
              <!-- Espacio para la barra de color -->
            </div>
            ...
            <div class="col-sm-9 col-7 position-relative">
              <div class="card-body py-2">
                <h5 class="card-title mb-1"><?php echo $colabo['tema']; ?></h5>
                ...
                <!-- Link que cubre solo esta sección, no toda la card -->
                <a href="<?php echo site_url('tarea/vertarea/' .$colabo['id_tarea']); ?>" class="stretched-link"></a>
              </div>
            </div>
</div>
</div>
